                ...
                <tbody class="divide-y divide-slate-100 text-slate-700">
                    @foreach($riwayat as $r)
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <td class="px-6 py-4 text-center font-bold text-blue-600">{{ $r->porsi_diterima }} / {{ $r->target_porsi }}</td>
                            ...
                            <td class="px-6 py-4">
                                ...
                                @else
                                    <span class="bg-red-100 text-red-700 text-xs px-2 py-1 rounded-full font-bold"><i
